                            ...
                            <ul class="list-unstyled">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mt-2 mb-1">Andi Setiawan</h5>
                                        Saya sangat puas dengan produk ini. Kualitasnya luar biasa dan sesuai dengan
                                        harapan.
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mt-2 mb-1">Rina Wijayanti</h5>
                                        Produk ini sangat bagus, pelayanan cepat dan memuaskan. Sangat direkomendasikan!
                                    </div>
                                </li>
                                <li class="media">
                                    <img src="/images/icons-testimonial-3.png" alt="" class="mr-3 rounded-circle" />
                                    <div class="media-body">
                                        <h5 class="mt-2 mb-1">Budi Santoso</h5>
                                        Sangat puas dengan produk ini. Desainnya keren dan performanya juga sangat baik.
                                    </div>
                                </li>
                            </ul>
                        </div>
